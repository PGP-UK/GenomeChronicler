...
class MyTestCase(unittest.TestCase):
    def test_something(self):
        ...
        gt_dir = input_dir/'ancestry_from_bam/gt'
        output_dir = Path('tests_temp/ancestry_from_bam')
        Path(output_dir).mkdir(parents=True, exist_ok=True)

        path_bam = input_dir/'NA12878wxs.bam.clean.BAM'
        path_bam_bai = input_dir/'NA12878wxs.bam.clean.BAM.bai' # important
        
        # if not (gt_dir/'temp').exists(): # prepare ground truth by perl
        #     os.system(f"perl perl/GenomeChronicler_ancestry_generator_fromBAM.pl {path_bam} {gt_dir} 8")
        #     os.system(f"mv {gt_dir}/results/results_NA12878wxs/* {gt_dir}")
        os.system(f"python3 scripts/GenomeChronicler_ancestry_generator_fromBAM.py {path_bam} {output_dir} 8")
        ...
        #NA12878wxs.g.vcf
        #NA12878wxs.g.vcf.idx
        #NA12878wxs.genotypes.vcf
        #NA12878wxs.genotypes.vcf.idx
